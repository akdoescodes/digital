...
export default function WebARMenu({ onClose, menuItems }: WebARMenuProps) {
  ...
  const createPlaneMesh = (plane: XRPlane): THREE.Mesh => {
          ...
          if (frame.detectedPlanes) {
            ...
            frame.detectedPlanes.forEach((plane) => {
              ...
              if (planePose) {
                ...
                const { position, quaternion } = planePose.transform;
                detectedPlane.mesh.position.set(position.x, position.y, position.z);
                detectedPlane.mesh.quaternion.set(quaternion.x, quaternion.y, quaternion.z, quaternion.w);
  ...
  const placeItem = async (event: React.MouseEvent) => {
